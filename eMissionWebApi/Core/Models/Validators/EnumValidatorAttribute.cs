...
namespace eMissionWebApi.Core.Models.Validators
{
	...
	/// <summary>
	/// Specifies that a field is required and exists as a value in the specified enum type.
	/// </summary>
	...
	public class EnumValidatorAttribute : ValidationAttribute
	{
		...
		protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
		{
			...
			return new ValidationResult($"'{value}' is not a valid value for {validationContext.DisplayName}. Valid values are: {string.Join(", ", Enum.GetNames(_enumType))}.");
		}
	}
}
